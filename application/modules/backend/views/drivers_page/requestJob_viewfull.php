                    ...
                    <div class="card-box height-100-p pd-20">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="ip-viewfullJob-deposit" id="ip-viewfullJob-deposit" class="form-control" readonly>
                            </div>
                        ...
                        <section id="sec_confirmPay_backend" style="display:none;">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12 form-group">
                                    ...
                                    <input type="number" name="ip-viewfullJob-numberPay" id="ip-viewfullJob-numberPay" class="form-control">
                                </div>
                            </div>
